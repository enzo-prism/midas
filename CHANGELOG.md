...
- Fix Codex account rows incorrectly showing unavailable usage; keep selected-account readings tied to verified account identity.
- Preserve local Codex spend history when switching accounts and distinguish pending readings from refresh errors.
